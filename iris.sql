...
--
-- Host: 127.0.0.1:3308
-- Generation Time: May 31, 2021 at 09:19 PM
...
CREATE TABLE IF NOT EXISTS `data` (
  ...
  `Species` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`Id`)
...
INSERT INTO `data` (`Id`, `SepalLengthCm`, `SepalWidthCm`, `PetalLengthCm`, `PetalWidthCm`, `Species`) VALUES
